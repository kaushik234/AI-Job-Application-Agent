          ...
          <div className="flex items-center space-x-2">
            {onToggleTheme && (
              <button
                ...
                className="flex-1 flex items-center justify-center space-x-2 py-2 px-3 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold transition-all cursor-pointer"
                title="Toggle theme"
              >
            ...
            {onLogout && (
              <button
                onClick={onLogout}
                className="p-2 rounded-lg bg-red-950/40 hover:bg-red-900/60 text-red-400 hover:text-red-300 border border-red-800/40 transition-all cursor-pointer"
                title="Logout"
              >
