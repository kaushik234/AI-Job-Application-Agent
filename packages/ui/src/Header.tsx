...
import { Play, Mail, RefreshCw, FileCode } from 'lucide-react';
    ...
    <header className="bg-slate-900/80 backdrop-blur border-b border-slate-800 text-slate-200 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="hidden lg:flex gap-4 text-[11px] text-slate-400 font-mono bg-slate-950/60 px-3 py-1.5 rounded-lg border border-slate-800">
          ...
          <span>DB: <span className="text-emerald-400 font-bold">POSTGRES</span></span>
          <span className="text-slate-700">|</span>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button
            ...
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-slate-950 font-bold text-xs px-3.5 py-2 rounded-lg transition-all shadow-md shadow-blue-500/20 cursor-pointer"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 text-xs font-semibold px-3.5 py-2 rounded-lg transition-all cursor-pointer"
          >
